/* CONFIG:{"nombre":"M&S COCHES OCASIÓN","color":"#057B9A","wa":"34660233031","waLabel":"¿Hablámos?","waMsg":"Hola, me gustaría recibir más información.","agentMsg":"Genial, completa tus datos y un comercial de nuestro equipo se pondrá en contacto contigo muy pronto.","vdp":"segunda-mano","vdpUrl":"https://www.myscochesocasion.com/honda-cr-v-20-i-vtec-luxury-gasolina-de-2012-en-madrid-de-segunda-mano-a01575f2-71e8-4ca8-9ea9-08efc154cc07","webhook":"https://services.leadconnectorhq.com/hooks/KpqGCidlNQD9x8fEpHft/webhook-trigger/68646492-9b92-4ea1-a6f1-ad50f504b03e","avatar":"https://assets.cdn.filesafe.space/oq7X7DQ0PSmkExuEI46j/media/54173186-f89e-4f70-94a8-4d18e934da24.png","btns":["Comprar coche 🚗","Consultar financiación💰"],"slug":"m-s-coches-ocasion","updatedAt":"2026-07-06T14:44:58.220Z"} */
/* RYT AGENCY — Chatbot Web v3 */
(function(){
  function init(){
    if(window._rytBot)return;
    window._rytBot=true;
    var N='M&S COCHES OCASIÓN',COLOR='#057B9A',WA='34660233031';
    ...
    var BTNS=['Comprar coche 🚗','Consultar financiación💰'];
    ...
    var xhr=new XMLHttpRequest();xhr.open("POST","https://services.leadconnectorhq.com/hooks/KpqGCidlNQD9x8fEpHft/webhook-trigger/68646492-9b92-4ea1-a6f1-ad50f504b03e",true);xhr.setRequestHeader("Content-Type","application/json");xhr.onreadystatechange=function(){if(xhr.readyState===4)done(n,ph,s);};var lbl=s.isVDP?"VDP: "+s.title:s.intent;xhr.send(JSON.stringify({firstName:n+" ["+lbl+"]",phone:ph,source:"CHATBOT WEB",tags:["chatbot"],notes:"Página: "+s.title}));};
    home();
