/* CONFIG:{"nombre":"Alvago Motors ","color":"#0673b7","color2":"#1a1a1a","wa":"34663697060","waLabel":"¿Hablámos?","waMsg":"Hola, me gustaría recibir más información.","agentMsg":"Genial, completa tus datos y un comercial de nuestro equipo se pondrá en contacto contigo muy pronto.","vdp":"segunda-mano","vdpUrl":"https://www.alvagomotors.com/kia-stonic-12-dpi-62kw-84cv-drive-gasolina-de-2023-de-segunda-mano-a4740a76-8c8c-44ad-b427-6fdf352a2dd8","webhook":"https://services.leadconnectorhq.com/hooks/D6XS4zkI1G2yym82AYmM/webhook-trigger/86434718-dd69-420d-9c1a-aa130ae0cb61","avatar":"https://assets.cdn.filesafe.space/oq7X7DQ0PSmkExuEI46j/media/54173186-f89e-4f70-94a8-4d18e934da24.png","btns":["Comprar coche 🚗","Quiero financiar💰"],"slug":"alvago-motors","updatedAt":"2026-05-24T21:48:24.187Z"} */
/* RYT AGENCY — Chatbot Web v3 */
(function(){
  function init(){
    if(window._rytBot)return;
    window._rytBot=true;
    var N='Alvago Motors ',COLOR='#0673b7',COLOR2='#1a1a1a',WA='34663697060';
    ...
    var BTNS=['Comprar coche 🚗','Quiero financiar💰'];
    ...
    var xhr=new XMLHttpRequest();xhr.open("POST","https://services.leadconnectorhq.com/hooks/D6XS4zkI1G2yym82AYmM/webhook-trigger/86434718-dd69-420d-9c1a-aa130ae0cb61",true);xhr.setRequestHeader("Content-Type","application/json");xhr.onreadystatechange=function(){if(xhr.readyState===4)done(n,ph,s);};var lbl=s.isVDP?"VDP: "+s.title:s.intent;xhr.send(JSON.stringify({firstName:n+" ["+lbl+"]",phone:ph,source:"CHATBOT WEB",tags:["chatbot"],notes:"Página: "+s.title}));};
    home();
