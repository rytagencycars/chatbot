    ...
    function initSellCarsRYT() {
        ...
        window._scForm = function(intent) {
            ...
            document.getElementById('sc-content').innerHTML = `
                ...
                <button id="sc-sub" class="sc-btn-main" onclick="window._scSend()">ENVIAR SOLICITUD</button>
            `;
        };
        ...
        window._scSend = function() {
            ...
            var btn = document.getElementById('sc-sub'); btn.innerText = "PROCESANDO..."; btn.disabled = true;
