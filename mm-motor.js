...
(function(){
  function init(){
    ...
    var AVATAR='https://assets.cdn.filesafe.space/oq7X7DQ0PSmkExuEI46j/media/d9610d4c-d93d-4365-8380-ae00858ee43e.png';
    ...
    var xhr=new XMLHttpRequest();xhr.open("POST","https://services.leadconnectorhq.com/hooks/Z9jyI4iqWRnEPYfhrH74/webhook-trigger/a3f5f688-735a-4d0c-85b1-bfaaeeef5aa7",true);xhr.setRequestHeader("Content-Type","application/json");xhr.onreadystatechange=function(){if(xhr.readyState===4)done(n,ph,s);};var lbl=s.isVDP?"VDP: "+s.title:s.intent;xhr.send(JSON.stringify({firstName:n+" ["+lbl+"]",phone:ph,source:"CHATBOT WEB",tags:["chatbot"],notes:"Página: "+s.title}));};
    home();
