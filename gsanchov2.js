/* CONFIG:{"nombre":"Gsancho","color":"#FFCC00","color2":"#1a1a1a","wa":"34608549040","waLabel":"Hablamos?","waMsg":"Hola, me gustaria recibir mas informacion.","agentMsg":"Genial, completa tus datos y un comercial de nuestro equipo se pondra en contacto contigo muy pronto.","vdp":"/main/","vdpUrl":"https://www.gsancho.es/main/producto/renault-megane-intens-tce-85-kw-115cv-gpf-ss/","webhook":"https://services.leadconnectorhq.com/hooks/oq7X7DQ0PSmkExuEI46j/webhook-trigger/5d6acf42-6a61-49b4-9f12-caf70dd841b8","avatar":"https://assets.cdn.filesafe.space/oq7X7DQ0PSmkExuEI46j/media/39d5f1a3-4882-468f-9fdd-8d149c4858c2.png","btns":["Quiero mas informacion"],"slug":"gsanchov2","updatedAt":"2026-05-11T21:12:12.642Z"} */
...
(function(){
  function init(){
    ...
    var VDP='/main/';
    var BTNS=['Quiero mas informacion'];
    ...
    st.innerHTML=`
      ...
      .ryt-trig{width:58px;height:58px;background:#1a1a1a;border-radius:50%;border:2.5px solid #FFCC00;box-sizing:border-box;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 20px rgba(0,0,0,.2);}
      ...
      .ryt-hdr h3{margin:4px 0 0;font-size:15px;font-weight:800;color:#FFCC00;}
      .ryt-hdr p{margin:4px 0 0;font-size:12px;color:#ffffff;opacity:.95;line-height:1.3;}
      .ryt-x{position:absolute;top:13px;right:14px;cursor:pointer;font-size:22px;color:#ffffff;opacity:.7;}
      .ryt-bk{position:absolute;top:13px;left:18px;cursor:pointer;font-size:20px;color:#ffffff;display:none;}
      ...
      .ryt-btn{width:100%;padding:11px;margin-bottom:8px;border:none;border-radius:10px;background:#FFCC00;color:#111111;cursor:pointer;font-size:14px;font-weight:700;font-family:-apple-system,sans-serif;}
      ...
      .ryt-inp:focus{border-color:#FFCC00;}
      .ryt-send{width:100%;padding:11px;border:none;border-radius:10px;background:#FFCC00;color:#111111;cursor:pointer;font-size:14px;font-weight:700;margin-bottom:6px;font-family:-apple-system,sans-serif;}
